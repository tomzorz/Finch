...
{
    /// <summary>
    /// A specialized frame buffer that allows doubled vertical resolution for graphics
    /// </summary>
    public class GraphicsFrameBuffer : FrameBuffer
    {
        internal GraphicsFrameBuffer(FinchConsole console, Character clearCharacter, string id, (int x1, int x2, int y1, int y2) pos) : base(console, clearCharacter, id, pos)
        {
        }
